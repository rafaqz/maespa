    ...
    IF(ISMAESPA)THEN
        IF (NOROOTDATES.GT.1) THEN
            DO I = 1,NOROOTSPEC    
                ...
                FRACROOTTABLE(1:NROOTLAYER,1:NOROOTDATES,I),FRACROOTSPEC(1:NROOTLAYER,I))
            ENDDO
        
        ELSE
            FRACROOTSPEC = FRACROOTTABLE(1:MAXSOILLAY,1,1:NOROOTSPEC)
        ENDIF
        ...
        DO I = 1,NOROOTSPEC
            ...
            FRACSUM = SUM(FRACROOTSPEC(1:NROOTLAYER,I))
                 ! modification mathias décembre 2012
            FRACROOTSPEC(1:NROOTLAYER,I) = FRACROOTSPEC(1:NROOTLAYER,I) / FRACSUM
        ENDDO
    ENDIF
